...
public class PCA {
    ...
    TODO
     ...
     implement com.example.ChatBot.PCA encode and decode to enable probabilistic ratings of suggestions and better performance than
     the current implementations nearest neighbor approach
     */
    int [][] utility = new int [][] {{10,1,10,0,5,2,2},{0,10,1,10,5,2,2},{0,1,1,0,10,10,2},{8,1,1,1,5,4,8}};//standard user matrix reduced via com.example.ChatBot.PCA in python
    int[] user;
