...
public class ChatBot {
    ...
    public ChatBot(){
        ...
        //questions.add(new com.example.ChatBot.question("generic", 0, "What service can I provide? "));  //considering to add two more elements, two to indicate the statement(s) index(s)
    ...
    public String getQuestion(int i,String s) {
        ...
        if (questions.size() >i ) {
            ...
            return "I can't think of another com.example.ChatBot.question";
    }
